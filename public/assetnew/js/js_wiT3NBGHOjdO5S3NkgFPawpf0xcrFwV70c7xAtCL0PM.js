...
;
/* Source and licensing information for the line(s) below can be found at https://gim.ac.in/modules/custom/custom_utility/js/custom_utility.js. */
(function (r, e) {
    e.behaviors.content_sidebar = {
        attach: function (e) {
            var a = 1;
            while (a > 0) {
                a = s(r)
            ...
            function s(r) {
                var e = r('p.unprocess_wrap').first().nextUntil(':not(.unprocess_wrap)').addBack().removeClass('unprocess_wrap');
                return r(e).wrapAll('<div class="highlighted" />').length;
                return r('p.unprocess_wrap').first().nextUntil(':not(.unprocess_wrap)').addBack().removeClass('unprocess_wrap').wrapAll('<div class="highlighted" />').length
            }
        }
    }
}(jQuery, Drupal));
...
function readMoreGroup(r) {
    var e = r('p.readmore_wrap').first().nextUntil(':not(.readmore_wrap)').addBack().removeClass('readmore_wrap').addClass('readmore-text'),
        a = r(e).wrapAll('<div class="read-more-wrapper" />').length;
    return a;
    return r('p.readmore_wrap').first().nextUntil(':not(.readmore_wrap)').addBack().removeClass('readmore_wrap').addClass('content-inner').wrapAll('<div class="read-more-wrapper" />').length
};
...
function setReadMore() {
    ...
    jQuery('.read-more-wrapper').each(function () {
        ...
        if (!jQuery(this).hasClass('.readmore-added') > 0 && a.length > r) {
            var e = a.substring(0, r);
            if (e) {
                $buttons_wrapper = '<div class="read-more-buttons" style="margin-top:20px"><a href="javascript:void(0)" class="readmore-link gim-text-link" >READ MORE</a><a href="javascript:void(0)" class="readless-link hide gim-text-link" >READ LESS</a></div>';
                jQuery(this).addClass('readmore-added hide').before('<div class="read-more-summary">' + jQuery.trim(e) + '...</div>');
                jQuery(this).after($buttons_wrapper);
                readmoreToggle()
            }
        }
    })
...
function readmoreToggle() {
    jQuery('.read-more-buttons .readmore-link').once().each(function () {
        jQuery(this).click(function () {
            jQuery(this).parent().siblings('.read-more-wrapper').fadeIn();
            jQuery(this).parent().siblings('.read-more-summary').hide();
            jQuery(this).siblings('.readless-link').show();
            jQuery(this).hide();
            return !1
        })
    });
    jQuery('.read-more-buttons .readless-link').once().each(function () {
        jQuery(this).click(function () {
            jQuery(this).parent().siblings('.read-more-wrapper').hide();
            jQuery(this).parent().siblings('.read-more-summary').fadeIn();
            jQuery(this).siblings('.readmore-link').show();
            jQuery(this).hide();
            return !1
        })
    })
};
/* Source and licensing information for the above line(s) can be found at https://gim.ac.in/modules/custom/custom_utility/js/custom_utility.js. */
;
