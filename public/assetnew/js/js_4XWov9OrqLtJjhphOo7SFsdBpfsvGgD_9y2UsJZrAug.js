/* Source and licensing information for the line(s) below can be found at https://gim.ac.in/core/assets/vendor/jquery.ui/ui/widgets/button-min.js. */
...
/* Source and licensing information for the above line(s) can be found at https://gim.ac.in/core/assets/vendor/jquery.ui/ui/widgets/button-min.js. */
;
/* Source and licensing information for the line(s) below can be found at https://gim.ac.in/core/assets/vendor/jquery.ui/ui/ie-min.js. */
/*! jQuery UI - v1.12.1 - 2017-03-31
 * http://jqueryui.com
 * Copyright jQuery Foundation and other contributors; Licensed  */
! function (a) {
...
/* Source and licensing information for the above line(s) can be found at https://gim.ac.in/core/assets/vendor/jquery.ui/ui/ie-min.js. */
;
/* Source and licensing information for the line(s) below can be found at https://gim.ac.in/core/assets/vendor/jquery.ui/ui/widgets/mouse-min.js. */
/*! jQuery UI - v1.12.1 - 2017-03-31
 * http://jqueryui.com
 * Copyright jQuery Foundation and other contributors; Licensed  */
! function (a) {
...
/* Source and licensing information for the above line(s) can be found at https://gim.ac.in/core/assets/vendor/jquery.ui/ui/widgets/mouse-min.js. */
;
/* Source and licensing information for the line(s) below can be found at https://gim.ac.in/core/assets/vendor/jquery.ui/ui/widgets/draggable-min.js. */
/*! jQuery UI - v1.12.1 - 2017-03-31
 * http://jqueryui.com
 * Copyright jQuery Foundation and other contributors; Licensed  */
! function (a) {
...
/* Source and licensing information for the above line(s) can be found at https://gim.ac.in/core/assets/vendor/jquery.ui/ui/widgets/draggable-min.js. */
;
/* Source and licensing information for the line(s) below can be found at https://gim.ac.in/core/assets/vendor/jquery.ui/ui/widgets/resizable-min.js. */
/*! jQuery UI - v1.12.1 - 2017-03-31
 * http://jqueryui.com
 * Copyright jQuery Foundation and other contributors; Licensed  */
! function (a) {
...
/* Source and licensing information for the above line(s) can be found at https://gim.ac.in/core/assets/vendor/jquery.ui/ui/widgets/resizable-min.js. */
;
/* Source and licensing information for the line(s) below can be found at https://gim.ac.in/core/assets/vendor/jquery.ui/ui/widgets/dialog-min.js. */
/*! jQuery UI - v1.12.1 - 2017-03-31
 * http://jqueryui.com
 * Copyright jQuery Foundation and other contributors; Licensed  */
! function (a) {
...
/* Source and licensing information for the above line(s) can be found at https://gim.ac.in/core/assets/vendor/jquery.ui/ui/widgets/dialog-min.js. */
;
/* Source and licensing information for the line(s) below can be found at https://gim.ac.in/themes/custom/gim/scripts/custom_webform.js. */
;
var timeOutWebform;
jQuery(window).on('load orientationchange', function (e) {
    clearTimeout(timeOutWebform);
    timeOutWebform = setTimeout(function () {
        jQuery('.webform-accordion-title').removeClass('opened');
        toggleClick()
    }, 50)
});
jQuery(document).ready(function (e) {
    e('.whatsapp-inquiry').find('.field-block-content--field-webform').hide();
    e('.open-whatsapp-form').once().click(function () {
    ...
    e(document).on('click', '.close-event-popup', function (o) {
        ...
        n.find('input[name="name"],input[name="mobile_number"],input[name="email"],input[name="comment"],input[name="event_date"],input[name="event_code"]').not('[type="submit"]').val('')
    })
});
jQuery(window).on('ajaxComplete', function (e) {
    toggleClick();
    if (jQuery('.webform-confirmation-modal--content').length > 0) jQuery('.event-popup').addClass('hide')
});

function toggleClick() {
    if (jQuery(window).width() < 769) {
        if (jQuery('.form-item--error').length > 0) {
            var e = jQuery('.form-item--error').first().closest('.webform-accordion');
            jQuery('.webform-accordion').removeClass('opened');
            jQuery('.webform-accordion-title').removeClass('opened');
            e.addClass('opened');
            e.find('.webform-accordion-title').addClass('opened');
            e.find('.webform-accordion-content').slideDown()
        };
        jQuery('.webform-accordion-title').on('click', function () {
            if (jQuery(this).hasClass('opened')) return !1;
            jQuery('.webform-accordion').removeClass('opened');
            jQuery('.webform-accordion-title').removeClass('opened');
            jQuery(this).addClass('opened');
            jQuery('.webform-accordion-content').slideUp();
            var e = jQuery(this).closest('.webform-accordion');
            e.addClass('opened');
            e.find('.webform-accordion-content').slideDown()
        });
        jQuery('.webform-proceed').on('click', function () {
            var e = jQuery(this).closest('.webform-accordion').next('.webform-accordion');
            jQuery('.webform-accordion').removeClass('opened');
            jQuery('.webform-accordion-title').removeClass('opened');
            jQuery('.webform-accordion-content').slideUp();
            e.addClass('opened');
        ...
        jQuery('.webform-accordion-title').removeClass('opened');
        jQuery('.webform-accordion-content').slideDown()
    }
};
/* Source and licensing information for the above line(s) can be found at https://gim.ac.in/themes/custom/gim/scripts/custom_webform.js. */
;
/* Source and licensing information for the line(s) below can be found at https://gim.ac.in/themes/contrib/adaptivetheme/at_core/scripts/min/at.breakpoints.min.js. */
! function (a, t, e) {
    'use strict';
    Drupal.behaviors.atBP = {
        attach: function (r, a) {
            if (t.matchMedia('only screen').matches) {
                var i = a[a.ajaxPageState.theme].at_breakpoints;
                for (var n in i) i.hasOwnProperty(n) && function (t, a) {
                    enquire.register(a, {
                        match: function () {
                ...
                }(n.split('_').join('-'), i[n].mediaquery)
            }
        }
    }
}(jQuery, window, document);
/* Source and licensing information for the above line(s) can be found at https://gim.ac.in/themes/contrib/adaptivetheme/at_core/scripts/min/at.breakpoints.min.js. */
;
/* Source and licensing information for the line(s) below can be found at https://gim.ac.in/modules/custom/custom_event/js/custom_event.js. */
;
var program_category = 'all',
    month_selected = 'all',
    year_selected = 'all',
    event_page = '';
jQuery(document).ready(function (e) {
    if (jQuery('body').hasClass('path-programmes-mdp')) {
        event_page = 'program'
    } else {
        event_page = 'institute'
    };
    createSlider();
    e('.mscrollbar-list').mCustomScrollbar();
    e(document).on('click', function (t) {
        if (e(t.target).closest('.custom-dropdown-wrapper').length == 0) {
            closeDrodowns()
        }
    });
    e('.custom-dropdown-wrapper').each(function () {
        var s = e(this),
            t = e(this).find('.custom-dropdown-list'),
            i = e(this).find('.custom-dropdown-list li'),
            o = e(this).find('.custom-dropdown-holder');
        o.on('click', function () {
            if (s.hasClass('open')) {
                closeDrodowns();
                return !1
            ...
            t.slideToggle();
            s.toggleClass('open');
            if (e(this).hasClass('selected')) t.find('li.default').show();
            else t.find('li.default').hide()
        });
        i.on('click', function () {
    ...
    e('.month-dropdown-list li').on('click', function () {
        month_selected = e(this).data('value') || 'all';
        loadEvents()
    });
    e('.year-dropdown-list li').on('click', function () {
        year_selected = e(this).data('value') || 'all';
        loadEvents()
    });
    e('.program-dropdown-list li').on('click', function () {
        program_category = e(this).data('value') || 'all';
        loadEvents()
    })
});
...
function loadEvents() {
    jQuery('#event-result').css('opacity', 0);
    var e = drupalSettings.path.baseUrl;
    if (jQuery('body').hasClass('path-programmes-mdp')) {
        url = e + 'events/program/' + month_selected + '/' + program_category
    } else {
        url = e + 'events/institute/' + month_selected + '/' + year_selected
    };
    var t = url;
    jQuery.ajax({
        type: 'GET',
        url: t,
        success: function (e) {
            var t = jQuery('#event-result');
            t.html(e.view);
            t.css('opacity', 1);
            jQuery('.no-event-text').hide();
            createSlider();
            if (e.count < 1) {
                jQuery('.no-event-text').show();
                t.closest('.components-container').addClass('empty-result')
            } else {
                t.closest('.components-container').removeClass('empty-result')
            };
...
function setCardHeight() {
    jQuery('.view-events .event-cards .card-info .body-section').equalHeights()
};

function createSlider() {
    if (event_page == 'program') {
        var e = jQuery('#event-result .view .view-content.view-rows');
        if (e.hasClass('slick-initialized')) e.slick('unslick');
...
function closeDrodowns() {
    jQuery('.custom-dropdown-wrapper').each(function () {
        var t = jQuery(this),
            s = jQuery(this).find('.custom-dropdown-list'),
            o = jQuery(this).find('.custom-dropdown-list li'),
            e = jQuery(this).find('.custom-dropdown-holder');
        s.slideUp();
        t.removeClass('open');
...
/* Source and licensing information for the above line(s) can be found at https://gim.ac.in/modules/custom/custom_event/js/custom_event.js. */
;
/* Source and licensing information for the line(s) below can be found at https://gim.ac.in/modules/custom/custom_menu/js/custom_menu.js. */
;
jQuery(document).ready(function (e) {
    manualActive();
    e('.gim-header-main-level-1 li.gim-menu-item').click(function (i) {
        var n = e(this);
        if (!isMobile()) {} else {
            if (e(i.target).hasClass('gim-accordion-trigger')) {
                e('.custom-menu_level1').not(n).removeClass('submenu-active').find('.gim-header-main-level-2').slideUp();
                e(n).toggleClass('submenu-active').find('.gim-header-main-level-2').slideToggle()
            }
        }
    });
    e('.nav-mobile').click(function () {
        e('.gim-header-main-level-1').slideToggle();
        e(this).toggleClass('active')
    });
    var i = e(window).width();
    layoutLeftAndRightPosition(i);
    onesideFullWidth(i);
    var n;
    ...
    e('html').on('click', function (i) {
        if (e(i.target).closest('.gim-header').length === 0) resetMenu()
    })
});

function animateHorizontalTab(e, i) {
    var n = e.scrollLeft(),
        t = i.width(),
        a = i.offset().left,
        l = jQuery(window).width() - t,
        s = n + a - l / 2 + 20;
    e.animate({
        scrollLeft: s
    })
...
function isMobile() {
    return jQuery(window).width() < 961
};

function layoutLeftAndRightPosition(e) {
    var i = (e - 1280) / 2;
    if (e >= 1280) {
        jQuery('.gim-branding').css('padding-left', i);
        jQuery('.gim-custom-user-menu').css('padding-right', i);
        jQuery('.title-slider-wrapper').css('padding-right', i)
    }
};

function onesideFullWidth(e) {
    var i = (e - 1280) / 2;
    if (e >= 1280) {
        jQuery('.oneside-full-width').css('max-width', 1280 + i)
    }
};

function resetMenu() {
    if (isMobile()) {
        jQuery('.gim-header-main-level-1').slideUp();
        jQuery('.nav-mobile').removeClass('active')
    } else {
        jQuery('.gim-header-main-level-1').css('display', '')
    };
    jQuery('.gim-menu-item').removeClass('submenu-active').find('.gim-header-main-level-2').slideUp()
};

function manualActive() {
    var n = window.location.pathname.split('/'),
        t = n[n.length - 2],
        e = jQuery('.gim-header-second');
    if (t) e.find('.' + t).addClass('is-active');
    var i = e.find('.gim-menu-link.is-active');
    i.closest('.gim-submenu-desktop-inner').show(function () {
        if (jQuery(window).width() <= 768 && jQuery('.breadcrumb').length > 0) {
            e.hide()
        } else {
            e.show();
            jQuery('body').removeClass('no-second-header');
            jQuery('.l-header').addClass('show-on-viewport')
        };
        animateHorizontalTab(e, i)
    })
};
/* Source and licensing information for the above line(s) can be found at https://gim.ac.in/modules/custom/custom_menu/js/custom_menu.js. */
;
